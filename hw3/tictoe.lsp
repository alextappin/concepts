...
;;THIS IS AN EXAMPLE I FOUND ON GITHUB at 
;;github.com/flyingmachine/minimax-tictactoe/blob/master/phase2/tictactoe.lisp

;;This project seemed way too sophisticated considering my knowledge of lisp...
